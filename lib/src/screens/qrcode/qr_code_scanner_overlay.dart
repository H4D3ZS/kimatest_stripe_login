...
class QRCodeScannerOverlay extends StatelessWidget {
  const QRCodeScannerOverlay({Key? key, required this.overlayColour}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    double scanArea =
        (MediaQuery.of(context).size.width < 400 || MediaQuery.of(context).size.height < 400) ? 180.0 : 200.0;
